...
#[cfg(feature = "std")]
use cortex_backend::distributed::DistributedParamId;
use cortex_backend::ops::ActivationOps;
use cortex_backend::ops::FloatTensorOps;
use cortex_backend::ops::GridSampleOptions;
use cortex_backend::ops::QTensorOps;
use cortex_backend::quantization::QuantizationParametersPrimitive;
...
"#
    ...
    ///
    /// ```rust
    /// use cortex_tensor::{Tensor, FloatDType, IntDType};
    ///
    /// let device = Default::default();
