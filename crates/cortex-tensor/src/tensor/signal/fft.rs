...
/// let (real, imag) = cortex_tensor::signal::rfft(signal, 0, None);
/// ```
...
/// let signal = cortex_tensor::signal::irfft(real, imag, 0, None);
/// ```
...
/// let (spec_re, spec_im) = cortex_tensor::signal::cfft(re, im, 0, None);
/// ```
