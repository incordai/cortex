use cortex_backend::ops::ModuleOps;
use cortex_dispatch::Dispatch;
use cortex_std::{MatmulTransformAction, MatmulTransformAnalysis, MatmulTransformPolicy};
...
/// Computes the [CTC loss](cortex_backend::ops::ModuleOps::ctc_loss).
///
/// # Arguments
///
...
/// Applies the [embedding module](cortex_backend::ops::ModuleOps::embedding).
...
/// Applies a [1D convolution](cortex_backend::ops::ModuleOps::conv1d).
///
...
/// Applies a [2D convolution](cortex_backend::ops::ModuleOps::conv2d).
///
/// Accepts [`ConvOptions`] for symmetric padding, or [`PaddedConvOptions`] for
/// asymmetric padding. When asymmetric padding is specified, an explicit pad
/// operation is applied before the convolution backend op.
...
/// Applies a [3D convolution](cortex_backend::ops::ModuleOps::conv3d).
///
/// Accepts [`ConvOptions`] for symmetric padding, or [`PaddedConvOptions`] for
...
/// Applies a [Deformable 2D convolution](cortex_backend::ops::ModuleOps::deform_conv2d).
...
/// Applies a [1D transposed convolution](cortex_backend::ops::ModuleOps::conv_transpose1d).
...
/// Applies a [2D transposed convolution](cortex_backend::ops::ModuleOps::conv_transpose2d).
...
/// Applies a 3D transposed convolution](cortex_backend::ops::ModuleOps::conv_transpose3d).
...
/// Applies a [4D to 3D unfold](cortex_backend::ops::ModuleOps::unfold4d).
...
/// Applies a [1D max pooling](cortex_backend::ops::ModuleOps::max_pool1d).
pub fn max_pool1d(
    x: Tensor<3>,
    kernel_size: usize,
    stride: usize,
...
/// Applies a [2D max pooling](cortex_backend::ops::ModuleOps::max_pool2d).
pub fn max_pool2d(
    x: Tensor<4>,
    kernel_size: [usize; 2],
    stride: [usize; 2],
...
/// Applies a [2D avg pooling](cortex_backend::ops::ModuleOps::avg_pool2d).
pub fn avg_pool2d(
    x: Tensor<4>,
    kernel_size: [usize; 2],
    stride: [usize; 2],
...
/// Applies a [1D avg pooling](cortex_backend::ops::ModuleOps::avg_pool1d).
pub fn avg_pool1d(
    x: Tensor<3>,
    kernel_size: usize,
    stride: usize,
...
/// Applies a [2D max pooling with indices](cortex_backend::ops::ModuleOps::max_pool2d_with_indices).
...
/// Applies a [2D adaptive avg pooling](cortex_backend::ops::ModuleOps::adaptive_avg_pool2d).
...
/// Applies a [3D adaptive avg pooling](cortex_backend::ops::ModuleOps::adaptive_avg_pool3d).
...
/// Applies a [1D adaptive avg pooling](cortex_backend::ops::ModuleOps::adaptive_avg_pool1d).
...
/// Applies a [2D interpolation](cortex_backend::ops::ModuleOps::interpolate).
pub fn interpolate(
    x: Tensor<4>,
    output_size: [usize; 2],
...
pub fn attention_fallback(
    ...
    Tensor::new(BridgeTensor::float(
        cortex_backend::ops::attention::attention_fallback::<Dispatch>(
            query.primitive.into_float(),
            key.primitive.into_float(),
            value.primitive.into_float(),
            mask.map(|mask| mask.primitive.into()),
...
/// Calculate the [2D convolution](cortex_backend::ops::ModuleOps::conv2d) backward pass, returning the gradient for `weight`.
