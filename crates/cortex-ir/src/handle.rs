...
impl<H: Clone> HandleContainer<H> {
    ...
    /// Get the [float tensor](cortex_backend::backend::BackendTypes::FloatTensorPrimitive) corresponding to the
    ...
    /// Get the [int tensor](cortex_backend::backend::BackendTypes::IntTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [bool tensor](cortex_backend::backend::BackendTypes::BoolTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [quantized tensor](cortex_backend::backend::BackendTypes::QuantizedTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Register a new [float tensor](cortex_backend::backend::BackendTypes::FloatTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [quantized tensor](cortex_backend::backend::BackendTypes::QuantizedTensorPrimitive) with the corresponding [tensor ids](TensorId).
    ...
    /// Register a new [int tensor](cortex_backend::backend::BackendTypes::IntTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [bool tensor](cortex_backend::backend::BackendTypes::BoolTensorPrimitive) with the corresponding [tensor id](TensorId).
