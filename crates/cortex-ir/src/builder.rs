...
impl_ir_create!(
    AllReduceOpIr {
        tensor: TensorIr,
        op: cortex_backend::distributed::ReduceOperation,
...
impl Unfold4dOpIr {
    ...
    pub fn create(
        ...
        let conv_options = cortex_backend::ops::ConvOptions::new(stride, padding, dilation, 1);
        let out_shape = cortex_backend::ops::conv::calculate_conv_output_shape(
            &x.shape,
            &weight_shape,
            &conv_options.stride,
