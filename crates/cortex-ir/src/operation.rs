...
pub enum FloatOperationIr {
    ...
    /// Operation corresponding to [powf](cortex_backend::ops::FloatTensorOps::float_powi).
    Powf(BinaryOpIr),
    /// Operation corresponding to [hypot](cortex_backend::ops::FloatTensorOps::float_hypot).
    Hypot(BinaryOpIr),
}
...
pub enum ModuleOperationIr {
    ...
    /// Operation corresponding to [linear](cortex_backend::ops::ModuleOps::linear).
    Linear(LinearOpIr),
    /// Operation corresponding to [linear_x_backward](cortex_backend::ops::ModuleOps::linear_x_backward).
    LinearXBackward(LinearXBackwardOpIr),
    /// Operation corresponding to [linear_weight_backward](cortex_backend::ops::ModuleOps::linear_weight_backward).
    LinearWeightBackward(LinearWeightBackwardOpIr),
    /// Operation corresponding to [linear_bias_backward](cortex_backend::ops::ModuleOps::linear_bias_backward).
    ...
    /// Operation corresponding to
    /// [adaptive avg pool 3d](cortex_backend::ops::ModuleOps::adaptive_avg_pool3d).
    AdaptiveAvgPool3d(AdaptiveAvgPool3dOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 3d backward](cortex_backend::ops::ModuleOps::adaptive_avg_pool3d_backward).
    ...
    /// Operation corresponding to [rfft](cortex_backend::ops::ModuleOps::rfft)
    Rfft(RfftOpIr),
    /// Operation corresponding to [irfft](cortex_backend::ops::ModuleOps::irfft)
    IRfft(IRfftOpIr),
    /// Operation corresponding to [attention](cortex_backend::ops::ModuleOps::attention).
    Attention(AttentionOpIr),
    /// Operation corresponding to [ctc_loss](cortex_backend::ops::ModuleOps::ctc_loss).
    CtcLoss(CtcLossOpIr),
    /// Operation corresponding to
    /// [ctc_loss_backward](cortex_backend::ops::ModuleOps::ctc_loss_backward).
    CtcLossBackward(CtcLossBackwardOpIr),
    /// Operation corresponding to [layer_norm](cortex_backend::ops::ModuleOps::layer_norm).
    LayerNorm(LayerNormOpIr),
    /// Operation corresponding to [unfold4d](cortex_backend::ops::ModuleOps::unfold4d).
    Unfold4d(Unfold4dOpIr),
    /// Operation corresponding to
    /// [conv_transpose1d_weight_backward](cortex_backend::ops::ModuleOps::conv_transpose1d_weight_backward).
    ConvTranspose1dWeightBackward(ConvTranspose1dWeightBackwardOpIr),
    /// Operation corresponding to
    /// [conv_transpose1d_bias_backward](cortex_backend::ops::ModuleOps::conv_transpose1d_bias_backward).
    ConvTranspose1dBiasBackward(ConvTranspose1dBiasBackwardOpIr),
    /// Operation corresponding to
    /// [conv_transpose2d_weight_backward](cortex_backend::ops::ModuleOps::conv_transpose2d_weight_backward).
    ConvTranspose2dWeightBackward(ConvTranspose2dWeightBackwardOpIr),
    /// Operation corresponding to
    /// [conv_transpose2d_bias_backward](cortex_backend::ops::ModuleOps::conv_transpose2d_bias_backward).
    ConvTranspose2dBiasBackward(ConvTranspose2dBiasBackwardOpIr),
    /// Operation corresponding to
    /// [conv_transpose3d_weight_backward](cortex_backend::ops::ModuleOps::conv_transpose3d_weight_backward).
    ConvTranspose3dWeightBackward(ConvTranspose3dWeightBackwardOpIr),
    /// Operation corresponding to
    /// [conv_transpose3d_bias_backward](cortex_backend::ops::ModuleOps::conv_transpose3d_bias_backward).
...
pub enum BaseOperationIr {
    ...
    /// Operation corresponding to:
    ///
    /// Float => [select assign](cortex_backend::ops::FloatTensorOps::float_select_assign).
    /// Int => [select assign](cortex_backend::ops::IntTensorOps::int_select_assign).
    ...
    /// Operation corresponding to:
    ///
    /// Float => [not_equal](cortex_backend::ops::FloatTensorOps::float_not_equal).
    /// Int => [not_equal](cortex_backend::ops::IntTensorOps::int_not_equal).
    /// Bool => [not_equal](cortex_backend::ops::BoolTensorOps::bool_not_equal).
    NotEqual(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [not_equal_elem](cortex_backend::ops::FloatTensorOps::float_not_equal_elem).
    /// Int => [not_equal_elem](cortex_backend::ops::IntTensorOps::int_not_equal_elem).
    /// Bool => [not_equal_elem](cortex_backend::ops::BoolTensorOps::bool_not_equal_elem).
...
pub enum NumericOperationIr {
    ...
    /// Operation corresponding to:
    ///
    /// Float => [argtopk](cortex_backend::ops::FloatTensorOps::float_argtopk).
    /// Int => [argtopk](cortex_backend::ops::IntTensorOps::int_argtopk).
    ArgTopK(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [topk](cortex_backend::ops::FloatTensorOps::float_topk).
    /// Int => [topk](cortex_backend::ops::IntTensorOps::int_topk).
    TopK(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [topk with indices](cortex_backend::ops::FloatTensorOps::float_topk_with_indices).
    /// Int => [topk with indices](cortex_backend::ops::IntTensorOps::int_topk_with_indices).
    ...
    /// Operation corresponding to:
    ///
    /// Float => [powf](cortex_backend::ops::FloatTensorOps::float_powi).
    /// Int => [powf](cortex_backend::ops::IntTensorOps::int_powi).
    Powi(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [powi_scalar](cortex_backend::ops::FloatTensorOps::float_powi_scalar).
    /// Int => [powi_scalar](cortex_backend::ops::IntTensorOps::int_powi_scalar).
    ...
    /// Operation corresponding to:
    ///
    /// Float => [neg](cortex_backend::ops::FloatTensorOps::float_neg).
    /// Int => [neg](cortex_backend::ops::IntTensorOps::int_neg).
    Neg(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sign](cortex_backend::ops::FloatTensorOps::float_sign).
    /// Int => [sign](cortex_backend::ops::IntTensorOps::int_sign).
    Sign(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [clamp_min](cortex_backend::ops::FloatTensorOps::float_clamp_min).
    /// Int => [clamp_min](cortex_backend::ops::IntTensorOps::int_clamp_min).
    ClampMin(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [clamp_max](cortex_backend::ops::FloatTensorOps::float_clamp_max).
    /// Int => [clamp_max](cortex_backend::ops::IntTensorOps::int_clamp_max).
    ClampMax(ScalarOpIr),
...
pub enum BoolOperationIr {
    ...
    Or(BinaryOpIr),
    /// Operation corresponding to [xor](cortex_backend::ops::BoolTensorOps::bool_xor).
    Xor(BinaryOpIr),
}
...
pub enum DistributedOperationIr {
    /// Operation corresponding to:
    /// [all_reduce](cortex_backend::distributed::DistributedOps::all_reduce).
    AllReduce(AllReduceOpIr),
    /// Resolve the pending collective operations on the executing device. Corresponds to
    /// [sync_collective](cortex_backend::distributed::DistributedOps::sync_collective).
    ///
...
pub struct AllReduceOpIr {
    ...
    pub op: cortex_backend::distributed::ReduceOperation,
    /// The devices participating in the collective operation.
    pub device_ids: Vec<DeviceIdIr>,
}

/// Serializable representation of a [device id](cortex_backend::DeviceId).
///
/// The intermediate representation is part of the wire protocol (e.g. the remote backend), so it
/// cannot store `cortex_backend::DeviceId` directly since that type is not serializable.
...
impl From<cortex_backend::DeviceId> for DeviceIdIr {
    fn from(value: cortex_backend::DeviceId) -> Self {
        Self {
...
impl From<DeviceIdIr> for cortex_backend::DeviceId {
    fn from(value: DeviceIdIr) -> Self {
        cortex_backend::DeviceId::new(value.type_id, value.index_id)
    }
}
...
pub enum ActivationOperationIr {
    /// [relu](cortex_backend::ops::ActivationOps::relu).
    Relu(UnaryOpIr),
    /// [relu_backward](cortex_backend::ops::ActivationOps::relu_backward).
    /// `lhs` = output of the forward pass, `rhs` = upstream gradient.
    ReluBackward(BinaryOpIr),
    /// [leaky_relu](cortex_backend::ops::ActivationOps::leaky_relu).
    /// `lhs` = input, `rhs` = `negative_slope` scalar.
    LeakyRelu(ScalarOpIr),
    /// [prelu](cortex_backend::ops::ActivationOps::prelu).
    /// `lhs` = input, `rhs` = alpha tensor.
    PRelu(BinaryOpIr),
    /// [gelu](cortex_backend::ops::ActivationOps::gelu).
    Gelu(UnaryOpIr),
    /// [gelu_backward](cortex_backend::ops::ActivationOps::gelu_backward).
    /// `lhs` = forward input, `rhs` = upstream gradient.
    GeluBackward(BinaryOpIr),
    /// [sigmoid](cortex_backend::ops::ActivationOps::sigmoid).
    Sigmoid(UnaryOpIr),
    /// [sigmoid_backward](cortex_backend::ops::ActivationOps::sigmoid_backward).
    /// `lhs` = output of the forward pass, `rhs` = upstream gradient.
    SigmoidBackward(BinaryOpIr),
    /// [hard_sigmoid](cortex_backend::ops::ActivationOps::hard_sigmoid).
    HardSigmoid(HardSigmoidOpIr),
    /// [log_sigmoid](cortex_backend::ops::ActivationOps::log_sigmoid).
    LogSigmoid(UnaryOpIr),
    /// [log_sigmoid_backward](cortex_backend::ops::ActivationOps::log_sigmoid_backward).
    /// `lhs` = forward input, `rhs` = upstream gradient.
    LogSigmoidBackward(BinaryOpIr),
    /// [softmax](cortex_backend::ops::ActivationOps::softmax).
    Softmax(DimOpIr),
    /// [log_softmax](cortex_backend::ops::ActivationOps::log_softmax).
    LogSoftmax(DimOpIr),
    /// [softmin](cortex_backend::ops::ActivationOps::softmin).
    Softmin(DimOpIr),
}
