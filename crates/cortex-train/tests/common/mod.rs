...
use cortex_optim::{ModuleOptimizer, SgdConfig, lr_scheduler::constant::ConstantLr};
use cortex_train::{InferenceStep, Learner, RegressionOutput, TrainOutput, TrainStep};
...
pub fn make_dataloaders() -> (
    Arc<dyn cortex_core::data::dataloader::DataLoader<DummyBatch>>,
    Arc<dyn cortex_core::data::dataloader::DataLoader<DummyBatch>>,
) {
