...
use cortex_core::{module::ParamGroup, tensor::Device};
use cortex_optim::{SgdConfig, lr_scheduler::module_lr_scheduler::ModuleLrSchedulerConfig};
use cortex_train::{Learner, SupervisedTraining, logger::InMemoryMetricLogger, metric::LossMetric};

/// Test the integration of [LrPolicyScheduler](cortex_optim::lr_scheduler::policy::LrPolicyScheduler) in cortex-train.
