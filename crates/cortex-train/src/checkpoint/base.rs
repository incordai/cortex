use cortex_core::store::{ModuleRecord, RecordError};
...
/// A record that can be saved to and loaded from a cortexpack file.
///
/// Implemented for the cortexpack record types used during training: the module
