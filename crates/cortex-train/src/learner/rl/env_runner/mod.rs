...
pub(crate) mod tests {
    ...
    impl Policy for MockPolicy {
        ...
        fn to_device(self, _device: &cortex_core::prelude::Device) -> Self {
            self
        }
    ...
    impl ToObservation<MockObservation> for MockState {
        fn to_observation(&self, _device: &cortex_core::prelude::Device) -> MockObservation {
    ...
    impl ToAction<MockPolicyAction> for MockAction {
        fn to_action(&self, _device: &cortex_core::prelude::Device) -> MockPolicyAction {
    ...
    impl PolicyLearner for MockLearningAgent {
        ...
        fn device(&self) -> cortex_core::prelude::Device {
            unimplemented!()
        }
    }
