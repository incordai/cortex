...
/// computation. Specifically, for the default 5 scales used by Cortex, the image dimensions
...
/// # Algorithm Overview
///
/// MS-SSIM computes structural similarity across M scales (M=5 in Cortex):
///
...
mod tests {
    ...
    use cortex_core::tensor::Distribution;
