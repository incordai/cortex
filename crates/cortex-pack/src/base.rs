//! Core types and constants for the Cortexpack file format.
//!
//! See the [parent module](crate::cortexpack) for the complete file format specification.
...
/// Magic number identifying a Cortexpack file: "CORTEX" in ASCII (0x4255524E)
...
/// Header structure for Cortexpack files
#[derive(Debug, Clone, Copy)]
pub struct Header {
    /// Magic number (4 bytes): 0x4255524E ("CORTEX")
    pub magic: u32,
...
/// A typed scalar value stored alongside tensors in a cortexpack container.
///
...
/// Error types for Cortexpack operations
#[derive(Debug)]
pub enum Error {
    InvalidHeader,
    InvalidMagicNumber,
