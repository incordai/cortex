...
/// Writer for creating Cortexpack files
pub struct Writer {
    /// Tensors to write
...
impl Writer {
    ...
    /// Calculate the total size needed for the cortexpack data.
    ///
    ...
    /// Write cortexpack data into a caller-provided buffer.
    ///
    ...
    ///
    /// This allocates a buffer internally and writes the cortexpack data.
    ...
    /// ([lazy](cortex_std::Bytes) device readback), file, or shared buffers — each
...
/// The computed on-disk layout of a cortexpack container.
///
...
/// A sequential destination for the bytes of a cortexpack container.
///
