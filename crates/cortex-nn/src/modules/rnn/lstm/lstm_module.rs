...
use cortex::prelude::Device;
use cortex::prelude::s;
...
mod test {
    ...
    use cortex_core::Tensor;
    use cortex_core::module::{Initializer, Param};
    use cortex_core::prelude::Device;
    use cortex_core::tensor::{Distribution, ElementConversion, Shape, TensorData, Tolerance};
    pub type FT = f32;
