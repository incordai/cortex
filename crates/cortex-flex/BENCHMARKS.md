...
All benchmarks run on Apple M3 Max, comparing cortex-flex against cortex-ndarray. Default features
...
These ops override cortex's default trait implementations with direct storage operations.
