...
impl IntTensorOps<Flex> for Flex {
    ...
    fn int_into_float(
        tensor: IntTensor<Flex>,
        out_dtype: cortex_std::FloatDType,
    ) -> FloatTensor<Flex> {
    ...
    fn int_any(tensor: IntTensor<Flex>, out_dtype: cortex_std::BoolDType) -> BoolTensor<Flex> {
    ...
    fn int_all(tensor: IntTensor<Flex>, out_dtype: cortex_std::BoolDType) -> BoolTensor<Flex> {
    ...
    fn int_full(
        shape: Shape,
        fill_value: cortex_backend::Scalar,
        _device: &Device<Flex>,
        dtype: IntDType,
    ) -> IntTensor<Flex> {
        let dt: DType = dtype.into();
    ...
    fn int_powi_scalar(lhs: IntTensor<Flex>, rhs: cortex_backend::Scalar) -> IntTensor<Flex> {
        use num_traits::ToPrimitive;
    ...
    fn int_powi_scalar_impl(lhs: IntTensor<Flex>, rhs: cortex_backend::Scalar) -> IntTensor<Flex> {
        use num_traits::ToPrimitive;
...
// migrated to cortex-backend-tests so they run against every backend.
// When adding new tests, keep them here only if they probe flex dtype
// storage; otherwise add them to
// crates/cortex-backend-tests/tests/tensor/int/ops/.
#[cfg(test)]
mod tests {
    use alloc::vec;
    ...
    fn test_u64_add_scalar_large() {
        ...
        let result = Flex::int_add_scalar(t, cortex_backend::Scalar::from(big));
    ...
    fn test_u64_greater_elem_large() {
        ...
        let result = Flex::int_greater_elem(
            t,
            cortex_backend::Scalar::from(big),
            cortex_std::BoolStore::Native,
        );
    ...
    fn test_int_mask_fill_i32() {
        ...
        let result = Flex::int_mask_fill(t, mask, cortex_backend::Scalar::from(0i64));
    ...
    fn test_int_mask_fill_i16() {
        ...
        let result = Flex::int_mask_fill(t, mask, cortex_backend::Scalar::from(-1i64));
    ...
    fn test_int_mask_fill_u8() {
        ...
        let result = Flex::int_mask_fill(t, mask, cortex_backend::Scalar::from(255i64));
    ...
    fn test_int_random_i32() {
        use cortex_backend::{DType, Distribution, ops::IntTensorOps};
    ...
    fn test_int_mean_i32() {
        use cortex_backend::{DType, ops::IntTensorOps};
