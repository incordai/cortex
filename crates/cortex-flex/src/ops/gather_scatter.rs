...
use alloc::vec;
use alloc::vec::Vec;
use cortex_backend::{DType, Element};
use cortex_std::{Bytes, Shape};
use bytemuck::Pod;
...
///
/// This is the internal index layer for cortex-flex: every indexed op
...
/// `U64` is accepted. This is intentional: cortex-flex's default `IntElem` is
...
/// in tracel-ai/cortex#4776 once it was confirmed that `read_indices` had
...
// crates/cortex-backend-tests/tests/tensor/float/ops/{gather_scatter,select}.rs
