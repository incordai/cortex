...
// permuted-argmax regressions have been migrated to cortex-backend-tests so
...
// otherwise add them to crates/cortex-backend-tests/tests/tensor/{float,int}/ops/.
#[cfg(test)]
mod tests {
    use alloc::vec;
    use cortex_backend::TensorData;
    use cortex_backend::ops::{FloatTensorOps, IntTensorOps};
    use cortex_std::{Shape, bf16, f16};
    ...
    // propagation contract itself is exercised in cortex-backend-tests
