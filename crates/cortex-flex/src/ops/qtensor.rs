...
use cortex_std::{Bytes, Shape, Slice, bf16, f16};
...
// crates/cortex-backend-tests/tests/tensor/float/quantization/ops/extended/
// so they run on every backend.
#[cfg(test)]
mod tests {
    use super::*;
    use cortex_backend::{TensorMetadata, quantization::QuantValue};
    ...
    fn test_per_block_quantize_dequantize() {
        use cortex_std::quantization::BlockSize;
    ...
    fn test_quantize_dynamic_f64_tensor() {
        use cortex_backend::quantization::QuantValue;
