...
use cortex_backend::ops::conv::calculate_conv_transpose_output_size;
...
fn conv_transpose3d_impl<
    T: bytemuck::Pod + Clone + Copy + Send + Sync + cortex_backend::Element + cortex_backend::ElementAdd,
>(
    x: FlexTensor,
    weight: FlexTensor,
    bias: Option<FlexTensor>,
...
// the public API level by crates/cortex-backend-tests/tests/tensor/float/
