...
//! Handle snapshots from the backing [`HandleContainer`](cortex_ir::HandleContainer)
...
//!
//! [`HandleContainer`](cortex_ir::HandleContainer) is shared per-device across the
...
use cortex_ir::{OperationIr, TensorId};
...
impl FusionReport {
    ...
    /// [`FusionLogLevel::Full`](cortex_std::config::fusion::FusionLogLevel). Useful for
...
pub struct FusionInspector {
    ...
    /// [`HandleContainer`](cortex_ir::HandleContainer) at the most recent quiescent
...
impl FusionInspector {
    ...
    /// The most recent [`HandleContainer`](cortex_ir::HandleContainer) size observed by
    ...
    /// [`HandleContainer`](cortex_ir::HandleContainer), or `None` if nothing has been
