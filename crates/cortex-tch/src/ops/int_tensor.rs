...
impl IntTensorOps<Self> for LibTorch {
    fn int_from_data(data: TensorData, device: &LibTorchDevice) -> TchTensor {
        match data.dtype {
            ...
            cortex_backend::DType::I32 => TchTensor::from_data::<i32>(data, (*device).into()),
            cortex_backend::DType::I16 => TchTensor::from_data::<i16>(data, (*device).into()),
            cortex_backend::DType::I8 => TchTensor::from_data::<i8>(data, (*device).into()),
            cortex_backend::DType::U8 => TchTensor::from_data::<u8>(data, (*device).into()),
