...
> from-scratch pure-Rust CPU backend that replaces `cortex-ndarray` with faster gemm, zero-copy view
> operations, native quantization, and full support for `std`, `no_std`, and WebAssembly. See
> [`cortex-flex/COMPARISON.md`](../cortex-flex/COMPARISON.md) for a migration path and
