...
#[cfg(feature = "fusion")]
type WgpuInner<C> = cortex_fusion::Fusion<CubeBackend<cubecl::wgpu::WgpuRuntime<C>>>;
...
/// # Notes
///
/// When the `fusion` feature flag is enabled (the default), this backend uses [cortex_fusion] to
...
mod tests {
    use super::*;
    use cortex_backend::{Backend, BoolStore, DType, DeviceOps};
