...
use cortex_tensor::{Tensor, TensorData, module, ops::ConvOptions};
use divan::Bencher;
...
macro_rules! bench_backend {
    ($mod_name:ident, $backend_name:literal) => {
        ...
        mod $mod_name {
            ...
            // 2.6-3.3x slowdown vs cortex-ndarray before the small-channel
            // fast path landed.
            ...
            // block reported in a user regression on cortex-ndarray parity.
            ...
            mod conv2d_depthwise {
                ...
                fn depthwise_7x7_4x24x56x56(bencher: Bencher) {
                    ...
                    // than cortex-ndarray before the depthwise fast path landed.
