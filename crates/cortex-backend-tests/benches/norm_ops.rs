...
//!
//! Covers `cortex::nn::LayerNorm::forward`'s decomposed primitive-ops path
//! (what you get by default from cortex-nn), the backend `layer_norm` fast
...
fn trait_layer_norm<const D: usize>(
    ...
    cortex_tensor::module::layer_norm(input, gamma, Some(beta), epsilon)
}
...
/// Decomposed layer_norm, mirroring what `cortex::nn::LayerNorm::forward`
