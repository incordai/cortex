...
use super::*;
use cortex_tensor::{Device, TensorData, Tolerance, activation::log_softmax, module::ctc_loss};

/// Deterministic logits: sin((t*7 + n*13 + c*3) * 0.1). Matches the
/// fixture generator in `cortex-nn/src/loss/ctc.rs`'s PyTorch comparison tests.
...
/// composition. Fixture lifted from cortex-nn's pytorch_comparison_tests.
#[test]
