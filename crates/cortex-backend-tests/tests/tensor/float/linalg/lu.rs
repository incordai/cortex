use super::*;
use cortex_tensor::{Distribution, Tolerance, linalg::lu};
...
// TODO: for correctness it might be good to allow users to disable some of these configs in cortex.toml.
#[cfg(feature = "cuda")]
const REL: f32 = 3e-2;
#[cfg(feature = "cuda")]
const ABS: f32 = 2e-2;
