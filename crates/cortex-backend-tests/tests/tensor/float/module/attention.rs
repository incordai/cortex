...
fn test_attention_no_mask() {
    ...
    #[cfg(feature = "metal")]
    if core::any::TypeId::of::<FloatElem>() == core::any::TypeId::of::<cortex_tensor::f16>() {
        return;
    }
...
/// Regression for cortex#4772: ONNX Attention-23 allows a `[1, 1, seq_q, seq_kv]` bias
...
/// Regression for cortex#4772: `[batch, 1, seq_q, seq_kv]` bias is shared across heads
...
/// Regression for cortex#4772: a `[1, 1, seq_q, seq_kv]` bool mask must be shared across
...
fn test_attention_bool_mask_broadcast_batch_and_heads() {
    ...
    // of #4325), not a cortex-flex or fallback bug. Enable once #4778 is fixed.
    #[cfg(feature = "cube")]
    if core::any::TypeId::of::<FloatElem>() == core::any::TypeId::of::<cortex_tensor::f16>() {
        return;
    }
