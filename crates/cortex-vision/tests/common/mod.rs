...
use cortex_core::tensor::{Device, Shape, TensorData};
use image::{DynamicImage, ImageBuffer, Luma, Rgb};

use cortex_core::tensor::{Bool, Int};

#[allow(unused)]
#[cfg(all(test, feature = "cuda"))]
pub type TestDevice = cortex_core::backend::CudaDevice;

#[allow(unused)]
#[cfg(all(test, feature = "rocm", not(feature = "cuda")))]
pub type TestDevice = cortex_core::backend::RocmDevice;

#[allow(unused)]
#[cfg(all(test, feature = "tch", not(any(feature = "cuda", feature = "rocm"))))]
pub type TestDevice = cortex_core::backend::LibTorchDevice;
...
pub type TestDevice = cortex_core::backend::WgpuDevice;
...
pub type TestDevice = cortex_core::backend::CpuDevice;
...
pub type TestDevice = cortex_core::backend::FlexDevice;

pub use cortex_core::tensor::Tensor;
