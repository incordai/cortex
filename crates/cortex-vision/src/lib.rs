...
macro_rules! dispatch_int_dtype {
    ($dtype:expr, |$ty:ident| $body:expr) => {
        match $dtype {
            cortex_core::tensor::IntDType::I64 => {
                type $ty = i64;
                $body
            }
            cortex_core::tensor::IntDType::I32 => {
                type $ty = i32;
                $body
            }
            cortex_core::tensor::IntDType::I16 => {
                type $ty = i16;
                $body
            }
            cortex_core::tensor::IntDType::I8 => {
                type $ty = i8;
                $body
            }
            cortex_core::tensor::IntDType::U64 => {
                type $ty = u64;
                $body
            }
            cortex_core::tensor::IntDType::U32 => {
                type $ty = u32;
                $body
            }
            cortex_core::tensor::IntDType::U16 => {
                type $ty = u16;
                $body
            }
            cortex_core::tensor::IntDType::U8 => {
                type $ty = u8;
                $body
            }
        }
...
macro_rules! dispatch_bool_dtype {
    ($dtype:expr, |$ty:ident| $body:expr) => {
        match $dtype {
            cortex_core::tensor::BoolStore::Native => {
                type $ty = bool;
                $body
            }
            cortex_core::tensor::BoolStore::U8 => {
                type $ty = u8;
                $body
            }
            cortex_core::tensor::BoolStore::U32 => {
                type $ty = u32;
                $body
            }
        }
