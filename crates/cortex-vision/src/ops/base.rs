...
use cortex_core::backend::{
    Backend, ExtensionType, TensorMetadata, backend_extension, tensor::{BoolTensor, IntTensor}
};
use cortex_core::tensor::{Int, IntDType, Scalar, Tensor, read_sync};
use cortex_core::{self as cortex, backend::tensor::FloatTensor}; // for backend_extension
...
#[cfg(feature = "flex")]
use cortex_core::backend::Flex;

#[cfg(feature = "wgpu")]
use cortex_core::backend::Wgpu;

#[cfg(feature = "webgpu")]
use cortex_core::backend::WebGpu;

#[cfg(feature = "vulkan")]
use cortex_core::backend::Vulkan;

#[cfg(feature = "metal")]
use cortex_core::backend::Metal;

#[cfg(feature = "cuda")]
use cortex_core::backend::Cuda;

#[cfg(feature = "rocm")]
use cortex_core::backend::Rocm;

#[cfg(feature = "cpu")]
use cortex_core::backend::Cpu;

#[cfg(feature = "tch")]
use cortex_core::backend::LibTorch;
