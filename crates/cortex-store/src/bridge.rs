//! Bridge between [`TensorSnapshot`] (cortex-core) and [`cortex_pack::Tensor`]
//! (the tensor-agnostic cortexpack format entry), used by [`CortexpackStore`](crate::CortexpackStore).
...
use cortex_pack::{Error as PackError, Tensor as PackTensor};
...
///
/// The tensor's [`Bytes`](cortex_pack::Bytes) may be file-backed (from [`Reader::from_file`](cortex_pack::Reader::from_file)),
