...
use cortex_core::tensor::{Bool, Device, Int, Shape, Tensor};
...
impl Applier {
    ...
    where
        K: cortex_core::tensor::kind::Basic,
    {
...
mod tests {
    ...
    use cortex_core::module::{ModuleMapper, Param, ParamId};
    use cortex_core::tensor::{DType, Tensor, TensorData};
    ...
    /// works through the full Applier flow with PyTorchToCortexAdapter.
    #[test]
    fn normalization_renaming_with_adapter() {
        ...
        // Applier with PyTorchToCortexAdapter
