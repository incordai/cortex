...
use crate::{
    CortexToPyTorchAdapter, ModuleSnapshot, ModuleStore, PyTorchToCortexAdapter, SafetensorsStore,
};
use cortex_core::module::{Module, Param};
use cortex_core::tensor::{Device, Tensor};
...
fn half_precision_adapter_without_module() {
    use crate::HalfPrecisionAdapter;
    use cortex_core::tensor::DType;
    use cortex_nn::{LayerNorm, LayerNormConfig};
