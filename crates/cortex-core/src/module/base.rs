...
use cortex_tensor::{Bool, Device, Int, Tensor};
...
pub trait Module: Clone + Send + core::fmt::Debug {
    ...
    ///
    /// The record can be saved to a cortexpack file or byte buffer and applied back with
    ...
    /// Save this module's parameters to a cortexpack file on disk.
    ///
    ...
    /// Load this module's parameters from a cortexpack file on disk, returning the loaded module.
    ///
