//! Integration test for the non-generic record system (`cortex_core::store`).
//!
//! Saves a (nested) module to a cortexpack record, loads it back into a freshly initialized
