...
/// `cortex_fusion::FusionUtilities::initialized_comms` set (and other consumers)
...
// backends and other cortex crates don't have to depend on it directly.
