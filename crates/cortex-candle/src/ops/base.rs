...
use cortex_backend::{DType, Element, Shape, TensorData, TensorMetadata};
...
pub fn cpu_random(shape: Shape, distribution: Distribution, dtype: DType) -> TensorData {
    ...
    let data = match dtype {
        ...
        DType::F16 => TensorData::random::<cortex_backend::f16, _, _>(shape, distribution, &mut rng),
        DType::BF16 => {
            TensorData::random::<cortex_backend::bf16, _, _>(shape, distribution, &mut rng)
        }
