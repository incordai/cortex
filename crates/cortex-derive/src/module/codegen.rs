...
pub(crate) fn generate_module_standard<Codegen: ModuleCodegen>(
    ...
    let mut codegen = quote! {
        ...
        impl #generics_module cortex::module::Module for #name #generics_ty_module #generics_where_module {
            #num_params_fn
        ...
        impl #generics_module_autodiff cortex::module::AutodiffModule for #name #generics_ty_module_autodiff #generics_where_module_autodiff
        {
            #valid_fn
...
pub(crate) fn generate_module_stateless<Codegen: ModuleCodegen>(
    ...
    let mut codegen = quote! {
        impl #generics cortex::module::Module for #name #generics_ty #generics_where {
            cortex::empty!(module);
        }

        impl #generics cortex::module::AutodiffModule for #name #generics_ty #generics_where {
            cortex::empty!(ad_module, #name #generics_ty);
        }
        ...
        module.types().into_iter().for_each(|ident| {
            ...
            if requires_module_bound {
                ...
                module_autodiff.add_predicate(parse_quote! {
                    #ident: cortex::module::AutodiffModule
                });
