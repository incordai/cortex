//! Legacy WebSocket tensor transfer, carried over the `cortex_communication` data service.
...
pub(crate) struct WebSocketTransfer<B: BackendIr> {
    pub(crate) inner: Arc<
        cortex_communication::external_comm::ExternalCommService<
            B,
            cortex_communication::websocket::WebSocket,
        >,
    >,
}
...
fn capability_to_legacy_id(
    capability: TransferCapability,
) -> cortex_communication::external_comm::TensorTransferId {
